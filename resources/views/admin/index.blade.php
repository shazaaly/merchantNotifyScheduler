            ...
            <div class="col-md-12 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class=" pt-1">
                            <p style="margin-top: 3rem;" class="text-sm mb-0 text-capitalize">New Merchants</p>
                            <p class="mb-0">
                                @php
                                ...
                                @foreach ($admin->notifications as $notification)
                                    <span> <strong>Merchant Username: </strong>{{$notification->data['username']}}</span>
                            <hr>
                            <span> <strong> Merchant Email: </strong>{{$notification->data['email']}}</span>
